...
export const achievements: Achievement[] = [
  ...
  { name: '重生之地产大亨', desc: '姜云升的地产帝国！', condition: '在交易所之地产版块累计购买地产数量>=10个达成（暂未开放）', event: false, ending: false, dlc: true },
  { name: '重生之绝对股神', desc: '姜云升的股票帝国！', condition: '在交易所之炒股版块累计购买股票收益率>=100%达成（暂未开放）', event: false, ending: false, dlc: true },
